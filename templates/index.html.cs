...
<head>
  ...
  <link rel="gettext" href="LC_MESSAGES/cs.json" />

  <script type="text/javascript" src="settings/initial.js"></script>

  <script type="text/javascript">
  <!--
    var initialLanguage = "cs";
  //-->
  </script>
...
<!-- task -->
      <li id="task">
        <h3 id="task-header" class="collapse">Úloha</h3> 
        <div id="task-container" class="collapse">
          <div id="task-options">
            <button class="button" onclick="javascript:proSoar.newTask();">Nový & Nahraj</button>
            <button class="button" onclick="javascript:proSoar.saveTask('open');">Uložit & Exportovat</button>
          </div>
...
<!--
          <div id="task-options-link">
            <a onclick="javascript:proSoar.taskGeneralOptions();">Obecné nastavení úlohy</a>
          </div>
-->
        </div>
      </li>
...
<!-- igc file upload -->
      <li id="igcfile">
        <h3 id="igcfile-header" class="collapse">Analýza</h3>
...
<!-- about -->
      <li id="about">
        <h3 id="about-header" onclick="javascript:proSoar.aboutDialog();">O aplikaci</h3>
...
<!--        Airspace data courtesy of <a href="http://www.soaringweb.org">Worldwide Soaring Turnpoint Exchange</a> -->
      ...
      <p>
        ...
        Translation to Czech by Nikola Zizkovsky
      </p>
    </div>
  </div>
